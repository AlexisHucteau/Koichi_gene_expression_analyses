...
colnames(Double_DEG_NR_R_REL) <- c("ID", "NR_R_logFC", "NR_R_AveExpr", "NR_R_t", "NR_R_P.Value", "NR_R_adj.P.Val", "NR_R_B", "R_REL_logFC", "R_REL_AveExpr", "R_REL_t", "R_REL_P.Value", "R_REL_adj.P.Val", "R_REL_B")
...
colnames(Double_MS_Viper_NR_R_REL) <- c("ID", "NR_R_size", "NR_R_nes", "NR_R_pval", "NR_R_pval.fdr", "REL_R_size", "REL_R_nes", "REL_R_pval", "REL_R_pval.fdr")
